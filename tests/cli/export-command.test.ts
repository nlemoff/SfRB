...
import { cleanupTempProjects, ensureBuilt, makeTempProject, writeWorkspaceFiles } from '../utils/bridge-browser';
...
async function runCliExport(projectRoot: string, outputPath?: string): Promise<ExportResult> {
